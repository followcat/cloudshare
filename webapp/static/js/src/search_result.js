    ...
    function($, radarcharts) {
        ...
        $('#vd-position').on('click', function() {
            ...
            if ($('#data-main').css('display') === 'none') {
                ...
                var myCharts = echarts.init(document.getElementById('echarts-wrap'));
        ...
        $('#vd-capacity-pro').on('click', function() {
            ...
            if ($('#data-main').css('display') === 'none') {
                ...
                var scatterCharts = echarts.init(document.getElementById('echarts-wrap'));
        ...
        $('#vd-capacity').on('click', function() {
            ...
            if ($('#data-main').css('display') === 'none') {
                ...
                var timeCharts = echarts.init(document.getElementById('echarts-wrap'));
