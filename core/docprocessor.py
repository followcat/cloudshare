...
class PandocProcessor(Processor):
    ...
    def convert(self):
        """
            ...
            >>> basepath = 'core/test_output'
            >>> f = open('core/test/cv_1.docx', 'r')
            >>> cv1 = core.docprocessor.PandocProcessor(f, 'cv_1.docx', basepath)
            >>> cv1.result
            True
...
class LibreOfficeProcessor(Processor):
    ...
    def convert(self):
        """
            ...
            >>> cv1 = core.docprocessor.LibreOfficeProcessor(f, 'cv_1.doc', basepath)
            >>> cv1.result
            True
