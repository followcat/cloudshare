...
MED_DB = interface.gitinterface.GitInterface(os.path.join(PRJ_PATH, 'medicinal'))
SVC_PRJ_MED = services.projectcv.ProjectCV(MED_DB, DATA_DB, 'medicinal', SVC_CV_STO)
